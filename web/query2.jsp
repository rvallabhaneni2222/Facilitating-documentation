...
%>
    <div class="wrapper">
        <article class="col3" style="background-color:#ccccff; width: 450px">
            <h3><B>Search Type..2</B></h3>
        <div class="pad">
            <p class="pad_bot2" style="text-align: justify;width: 550px;"><strong>
                    
                    
                    <div style="margin-left: 3px;">  
                        <form action="result2.jsp" method="get" onsubmit="return check()">
                  Strom Name:<br>
                  <input type="text" name ="q1" style="height: 30px; width: 180px;"> 
                  <input type="submit" value="Query 2" style="background-color:#3333ff; width: 80px; height: 30px; border: 4px; font-weight: bold;">&nbsp;&nbsp;&nbsp;<br><br>
                    Category:<br>    
                           <input type="text" name ="q2"  style="height: 30px; width: 180px;"> 
