  ...
  <div class="main">
    <header>
      <div class="wrapper">
        <nav>
          <ul id="menu">
            <li id="menu_active"><a href="login.jsp">Home</a></li>
        ...
        <div class="pad">
            <p class="pad_bot2" style="text-align: justify;width: 550px;"><strong>
                    ...
                    <div style="margin-left: 3px;">  
                        <a href="query1.jsp"><input type="submit" value="Query" style="background-color:#3333ff; width: 80px; height: 30px; border: 4px; font-weight: bold;">&nbsp;&nbsp;&nbsp;</a>
               
                        <a href="con1.jsp"><input type="submit" value="Condent" style="background-color: #ff6699; height: 30px; width: 80px; border: 4px; font-weight: bold;"></a></div>
