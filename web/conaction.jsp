      ...
      <div class="wrapper">
        <nav>
          <ul id="menu">
            ...
            <li><a href="query1.jsp">Query</a></li>
            <li><a href="con1.jsp">Back</a></li>
...
ResultSet rs = st.executeQuery("select * from admin where docname='"+a+"' ");
if(rs.next()){
    s = rs.getString("strom");
    w = rs.getString("war");
    b = rs.getBlob("file");
    aid = rs.getString("id");
                         // session.setAttribute("dd", b);
...
<%
    ...
    <%= f %>  
     ...
     <div>          
         <b>Strom Name:<%= s %></b> <br>
       <!--  <form action="Download_1.jsp" method="post" enctype="multipart/form-data">
             <input type="submit" value="Downlaod" style="background-color: green; font-weight: bold">
                    
         </form>
       -->
       <a href="Download_1.jsp?<%=aid%>"> <button style="background-color: green"> Download </button> </a>        
          </strong>              
 <%} 
else{
