        ...
        <div class="pad">
            <p class="pad_bot2" style="text-align: justify;width: 550px;"><strong>
                    ...
                    <div style="margin-left: 3px;">  
                        ...
                        Document Type:<br>
                            <input type="text" name ="q1" style="height: 30px; width: 180px;"> 
                        <input type="submit" value="Query 3" style="background-color:#3333ff; width: 80px; height: 30px; border: 4px; font-weight: bold;">&nbsp;&nbsp;&nbsp;<br><br>
                 
                     Location:<br>
                           <input type="text" name ="q2"  style="height: 30px; width: 180px;"> <br><br>
                           
                           
                
                     Date:<br>
                         <input type="date" name ="q3" style="height: 30px; width: 180px;">
